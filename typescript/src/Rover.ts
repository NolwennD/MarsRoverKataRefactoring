export class Rover {
  ...
  constructor(private x: number, private y: number, private heading: string) {
  }

  public execute(commands: string, obstacles: number[][]): string {
